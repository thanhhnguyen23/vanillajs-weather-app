...
function renderForecast(forecast) {
	...
	forecast.forEach((weatherData) => {
		const fTemp = weatherData.main.temp * 1.8 + 32;
     ...
     <p class="forecast__temp">${Math.floor(fTemp)}°F</p>
...
function getCityWeather(url) {
 ...
 <div class="weather__summary">
    <p><i class="wi ${icons[data.weather[0].icon]} weather-icon"></i> <span class="weather__celsius-value">${Math.floor(fTemp)}°F</span></p>
